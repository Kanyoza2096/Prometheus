    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-brand-bg">
      ...
      >
        <motion.div 
          ...
          className="bg-brand-surface/70 backdrop-blur-2xl border border-brand-border/50 p-8 rounded-3xl shadow-[0_0_60px_rgba(79,70,229,0.1),0_0_0_1px_rgba(79,70,229,0.05)_inset]"
        >
          {/* Logo Section */}
