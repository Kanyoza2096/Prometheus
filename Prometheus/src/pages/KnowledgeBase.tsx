    ...
    >
      ...
      >
        ...
        <div className="flex gap-3">
          <button className="px-4 py-3 bg-brand-elevated border border-brand-border rounded-xl text-brand-text text-sm font-bold hover:bg-brand-border/30 transition-colors flex items-center space-x-2">
            <Upload className="w-4 h-4" />
            <span>Upload</span>
          </button>
          <button className="px-4 py-3 bg-brand-primary text-white rounded-xl text-sm font-bold hover:bg-brand-primary/90 transition-colors flex items-center space-x-2 shadow-glow-primary">
        ...
        {filteredDocuments.map((doc, idx) => (
          ...
          >
            ...
            <div className="flex gap-2 mt-4 pt-4 border-t border-brand-border">
              <button className="flex-1 px-3 py-2 text-xs font-bold text-brand-text bg-brand-elevated rounded-lg hover:bg-brand-border/30 transition-colors flex items-center justify-center space-x-1">
                <Edit2 className="w-3 h-3" />
                <span>Edit</span>
              </button>
              <button className="flex-1 px-3 py-2 text-xs font-bold text-brand-danger bg-brand-danger/10 rounded-lg hover:bg-brand-danger/20 transition-colors flex items-center justify-center space-x-1">
